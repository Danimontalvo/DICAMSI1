...
class MASCOTA{
	...
	function consultar(){
		 ...
		 $res=$cont->query($query);
		  echo"<table border='1'>";
		echo"<tr>";
			echo"<th><font color='black' size='4' face='Arial'>ID</th>
			<th><font color='black' size='4' face='Arial'></th></th>
			<th><font color='black' size='4' face='Arial'>NOMBRE DE LA MASCOTA</th>
			<th><font color='black' size='4' face='Arial'>TAMANO DE LA MASCOTA</th>
			<th><font color='black' size='4' face='Arial'>HOGAR</th>
			<th><font color='black' size='4' face='Arial'>ESTADO</th>";
