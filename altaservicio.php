...
<form action="datos_servicio.php" method="GET">
CARACTERISTICAS:<br><input type="text" name="CARACTERISTICAS"><br><br> 
PRECIO_SER:<br><input type="numerico" name="PRECIO_SER"><br><br> 
