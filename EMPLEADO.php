...
class EMPLEADO{
	...
	function consultar(){
		 ...
		 echo"<table border='1'>";
		echo"<tr>";
			echo"<th><font color='Red' size='4' face='Arial'>ID</th>
			<th><font color='Red' size='4' face='Arial'>NOMBRE</th>
			<th><font color='Red' size='4' face='Arial'>TELEFONO</th>
			<th><font color='Red' size='4' face='Arial'>EXPERIENCIAS</th>
			<th><font color='Red' size='4' face='Arial'>ESTADO</th>";
